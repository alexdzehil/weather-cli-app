...
def read_user_cli_args():
    ...
    parser.add_argument(
        ...
        '--imperial',
        action='store_true',
        help='display the temperature units'
    )
...
def build_weather_query(city_input, imperial=False):
    ...
    Args:
        ...
        imperial (bool): Weather or not to use imperial for temperature
...
def display_weather_info(weather_data, imperial=False):
    """
    Prints formatted ewather information about a city.

    Args:
        weather_data (dict): API response from OpenWeather by city name
        imperial (bool): Weather or not to use imperial units for temperature
    """
    ...
    print(f'({temperature}{a}{"F" if imperial else "C"})')
